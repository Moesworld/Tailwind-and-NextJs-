...
export default function Navbar() {
    ...
    return (
        <nav className=" bg-skin-shades-2 border-gray-200 px-2 w-full py-6 sticky top-0 z-50">
        <div className="container mx-auto flex flex-wrap items-center justify-between">
            <Link href="/" replace={true}>
            <a className="flex">
            
                <span className="pl-4 self-center text-3xl text-white whitespace-nowrap">SS</span>
            </a>
            </Link>
