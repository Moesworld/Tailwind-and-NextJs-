...
export default function Navbar() {
    ...
    return (
        ...
        <div className="container mx-auto flex flex-wrap items-center justify-between">
            ...
            <ul className="flex-col md:flex-row flex md:space-x-8 mt-4 md:mt-0 md:text-sm md:font-medium" onClick={toggle}>
                <li>
                <Link href="/">
                <a  className="bg-blue-700 md:bg-transparent text-white block pl-3 pr-4 py-2 md:text-blue-700 md:p-0 rounded" aria-current="page">Home</a>
                </Link>
                </li>
                <li>
                <Link href="/about">
