            ...
            <div className="md:flex md:justify-between">
                <div className="mb-6 md:mb-0">
                    ...
                    <a  className="flex items-center">
                        ...
                        <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">SummerSkin</span>
                    </a>
                    </Link>
                </div>
                <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    <div>
                        ...
                        <ul>
                            <li className="mb-4">
                                ...
                                <a  className="text-gray-600 hover:underline dark:text-gray-400">Flowbite</a>
                                </Link>
                            </li>
                            <li>
                                <Link href="https://tailwindcss.com/">
                                <a   rel="nofollow" className="text-gray-600 hover:underline dark:text-gray-400">Tailwind CSS</a>
                                </Link>
                            </li>
                        </ul>
                    </div>
                        ...
                        <ul>
                            <li className="mb-4">
                                <Link href="https://github.com/themesberg/flowbite" >
                                 <a  className="text-gray-600 hover:underline dark:text-gray-400">Github</a>
                                </Link>
                            </li>
                            <li>
                                <Link href="https://discord.gg/4eeurUVvTy" >
                                <a   className="text-gray-600 hover:underline dark:text-gray-400">Discord</a>
                                </Link>
                            </li>
                        </ul>
                    </div>
                    <div>
                        ...
                        <ul>
                            <li className="mb-4">
                                <Link href="/">
                                <a  className="text-gray-600 hover:underline dark:text-gray-400">Privacy Policy</a>
                                </Link>
                            </li>
                            <li>
                                <Link href="/" >
                                <a  className="text-gray-600 hover:underline dark:text-gray-400">Terms &amp; Conditions</a>
                                </Link>
