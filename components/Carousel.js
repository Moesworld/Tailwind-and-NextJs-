        ...
        <div  id="default-carousel" data-carousel="slide" className="relative">
            ...
            <div className="overflow-hidden relative h-56 rounded-lg sm:h-64 xl:h-80 2xl:h-96">
                ...
                <div className="hidden duration-700 ease-in-out" data-carousel-item="active">
                    <img src="./images/carousel/image1.jpg" className="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="..."/>
                </div>

              
                <div className="hidden duration-700 ease-in-out" data-carousel-item="">
                    <img src="./images/carousel/image2.jpg" className="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="..."/>
                </div>

                
                <div className="hidden duration-700 ease-in-out" data-carousel-item="">
                    <img src="./images/carousel/image3.jpg" className="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="..."/>
                </div>

               
                <div className="hidden duration-700 ease-in-out" data-carousel-item="">
                    <img src="./images/carousel/image4.jpg" className="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="..."/>
                </div>

                
                <div className="hidden duration-700 ease-in-out" data-carousel-item="">
                    <img src="./images/carousel/image5.jpg" className="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="..."/>
                </div>
            </div>
